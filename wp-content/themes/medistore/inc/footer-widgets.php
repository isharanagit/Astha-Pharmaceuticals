...
class  medistore_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'medistore';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'medistore' ), $i ),
...
// Initialize.
$medistore_footer_widgets = new  medistore_Footer_Widgets();
