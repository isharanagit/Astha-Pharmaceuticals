...
$wp_customize->register_control_type( 'Online_Pharmacy_Toggle_Control' );
	...
	$wp_customize->add_setting( 'online_pharmacy_tp_color_option', array(
  	...
  	$wp_customize->add_setting( 'online_pharmacy_tp_color_option_link', array(
	    'default' => '',
	    'sanitize_callback' => 'sanitize_hex_color'
  	));
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'online_pharmacy_tp_color_option_link', array(
	    'description' => __('It will change the complete theme hover link color in one click.', 'online-pharmacy'),
	    'section' => 'online_pharmacy_color_option',
	    'settings' => 'online_pharmacy_tp_color_option_link',
  	)));
   ...
   // Add Settings and Controls for Post Layout
	...
	$wp_customize->add_section('online_pharmacy_blog_option',array(
		...
		$wp_customize->add_control( new Online_Pharmacy_Toggle_Control( $wp_customize, 'online_pharmacy_remove_date', array(
			'label'       => esc_html__( 'Show / Hide Date Option', 'online-pharmacy'),
			'section'     => 'online_pharmacy_blog_option',
			'type'        => 'toggle',
			'settings'    => 'online_pharmacy_remove_date',
		) ) );
    $wp_customize->selective_refresh->add_partial( 'online_pharmacy_remove_date', array(
		...
		$wp_customize->add_control( new Online_Pharmacy_Toggle_Control( $wp_customize, 'online_pharmacy_remove_author', array(
			'label'       => esc_html__( 'Show / Hide Author Option', 'online-pharmacy'),
			'section'     => 'online_pharmacy_blog_option',
			'type'        => 'toggle',
			'settings'    => 'online_pharmacy_remove_author',
		) ) );
    $wp_customize->selective_refresh->add_partial( 'online_pharmacy_remove_author', array(
		...
		$wp_customize->add_control( new Online_Pharmacy_Toggle_Control( $wp_customize, 'online_pharmacy_remove_comments', array(
			'label'       => esc_html__( 'Show / Hide Comment Option', 'online-pharmacy'),
			'section'     => 'online_pharmacy_blog_option',
			'type'        => 'toggle',
			'settings'    => 'online_pharmacy_remove_comments',
		) ) );
...
if ( ! defined( 'ONLINE_PHARMACY_PRO_THEME_URL' ) ) {
	define( 'ONLINE_PHARMACY_PRO_THEME_URL', esc_url('https://www.themespride.com/themes/online_pharmacy-wordpress-theme/'));
}
