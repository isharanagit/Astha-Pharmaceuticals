...
class Online_Pharmacy_Range_Slider extends WP_Customize_Control {
    ...
    public function enqueue() {
        wp_enqueue_style( 'online_pharmacy-range-control-styles', get_parent_theme_file_uri( '/assets/css/range.css' ), false, '1.0.0', 'all' );
        wp_enqueue_script( 'online_pharmacy-range-control-scripts', get_parent_theme_file_uri( '/assets/js/range.js' ), array( 'jquery' ), '1.0.0', true );
    }
    /**
